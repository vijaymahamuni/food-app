        ...
        <div className="border-b-2 border-gray-200 flex justify-between">
          <div className="w-9/12 my-4">
            <div>
              ...
              <span
                className={`${
                  items?.card?.info?.ratings?.aggregatedRating?.rating > 3
                    ? "text-green-600"
                    : "text-yellow-600"
                }`}
              >
          ...
          <div>
            <button
              className="p-1 m-1 w-20 font-bold text-green-600 bg-white absolute my-28 ml-10 rounded-md"
            ...
            <div className="p-2">
              <img
                src={MENUCARD_IMG + items.card.info.imageId}
