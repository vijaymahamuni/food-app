...
const Contact = () => {
    return (
        <div >
            <h1 className=" bg-orange-100 p-20 text-4xl font-[500] text-center" >Contact Us</h1>
            <div className="mx-auto flex justify-evenly">
                <div className="p-6 m-16 w-[500px] bg-white shadow-lg">
                    ...
                    <h1 className="mt-6">La cliff, No.11, 1st Floor, VOC St, Ranga Colony, Sembakkam, Rajakilpakkam, Tamil Nadu 600073.
                    </h1>
                    <h1>
                        5A, 47/48, 1st Cross Street, Ranga Colony, Rajakilpakkam,
                        Chennai – 600 073.</h1>
                </div>
                <div className="p-6 m-16 w-[200px] bg-white shadow-lg">
                    <img src="https://img.freepik.com/free-vector/telephone-call-icon-3d-vector-illustration-social-media-symbol-networking-sites-apps-cartoon-style-isolated-white-background-online-communication-digital-marketing-concept_778687-1734.jpg?size=338&ext=jpg&ga=GA1.1.2008272138.1724112000&semt=ais_hybrid" alt="" className="w-32 h-20" />
                ...
                <div className="p-6 m-16 w-[300px] bg-white shadow-lg">
                    ...
                    <img src="https://freepngimg.com/download/gmail/66572-google-icons-computer-logo-email-gmail.png" alt="" className="ml-16 w-28 h-20" />
